...
namespace AbstractCafeRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IDishService, DishServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IChefService, ChefServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IMenuService, MenuServiceBD>(new HierarchicalLifetimeManager());
            container.RegisterType<IKitchenService, KitchenServiceBD>(new HierarchicalLifetimeManager());
